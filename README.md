...
## Using docker engine on a container space
...
docker run -p 8080:8080 -e AZURE_STORAGE_ACCOUNT=$AZURE_STORAGE_ACCOUNT -e AZURE_STORAGE_ACCESS_KEY=$AZURE_STORAGE_ACCESS_KEY -e RUST_ROCKET_EXACT_ORIGIN=$RUST_ROCKET_EXACT_ORIGI giuliohome/doc-manager:latest
```
